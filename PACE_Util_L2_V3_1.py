...
class OCI_L2_CLD_NRT:
    def __init__(self, granule_timestamp: str, data_path: str = './'):
        ...
        """
        cldmask_fn = f"{data_path}PACE_OCI.{granule_timestamp}.L2.CLDMASK.V3_1.nc"
        cldretr_fn = f"{data_path}PACE_OCI.{granule_timestamp}.L2.CLD.V3_1.nc"
...
class HARP2_L1(object):
    ...
    def plot_true_color_RGB(self, figsize=[20,20], save_RGB=False, x0_indices=None, y0_indices=None,
